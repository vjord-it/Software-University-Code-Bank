namespace Forum.App.Controllers
{
    ...
    public class CategoryController : IController, IPaginationController
    {
        ...
        private void GetPosts()
        {
            ...
            this.PostTitles = allCategoryPosts.Skip(this.CurrentPage * PAGE_OFFSET).Take(PAGE_OFFSET).Select(p => p.Title).ToArray();
        }
        ...
        {
            GetPosts();
            string categoryName = PostService.GetCategoryById(this.CategoryId).Name;
