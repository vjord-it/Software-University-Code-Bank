package Lesson02Encapsulation.Exercise.pr04_shopping_spree;
...
public class Main {
    ...
    private static String getPersonInfo(Person person) {
        ...
        if (person.getShoppingCart().isEmpty()) {
            ...
            // Slow - 0.067s vs 0.010s with foreach and individual append
//            info.append(this.shoppingCart.stream()
//                    .map(Product::getName)
